...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (button.getId()) {
            ...
            case R.id.startButton:
                ...
                */
                final URL url6 = stringToURL("http://res.cloudinary.com/smartlock/image/upload/v1519143645/sample.jpg");
                ...
                ImageDownloader imageDownloader = new ImageDownloader(getApplicationContext(), new ProgressDialog(SettingsActivity.this));

                mMyTask = imageDownloader
                        .execute(
                                /*
                                url1,
                                url2,
                ...
                imageDownloader.getImagesFromLocalStorrage();
    ...
    private void dropPassword() {
        SharedPreferences sharedPref = getSharedPreferences("PasswordPreferences", MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPref.edit();
